...
class LifecycleCommandRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return match ($this->route()?->getActionMethod()) {
            ...
            'requestProof' => ['source_file_id' => 'required|integer|exists:article_files,id'],
            'proofResponse' => ['decision' => 'required|in:approve,corrections', 'comments' => 'required_if:decision,corrections|nullable|string|max:20000', 'article_file_id' => 'nullable|integer|exists:article_files,id'],
