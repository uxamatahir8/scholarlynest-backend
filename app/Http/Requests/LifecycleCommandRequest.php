...
class LifecycleCommandRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return match ($this->route()?->getActionMethod()) {
            ...
            'inviteReviewer' => ['article_version_id' => 'required|integer|exists:article_versions,id', 'reviewer_id' => 'nullable|integer|exists:users,id', 'name' => 'nullable|string|max:255', 'email' => 'nullable|email|max:255', 'due_at' => 'nullable|date'],
