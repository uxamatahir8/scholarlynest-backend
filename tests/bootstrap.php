...
if ($testEnvironment !== 'testing'
    ...
    fwrite(STDERR, sprintf(
        "DATABASE SAFETY FAILED: APP_ENV=%s DB_CONNECTION=%s DB_HOST=%s DB_DATABASE=%s ALLOW_DESTRUCTIVE_TEST_DATABASE=%s.\n",
...
fwrite(STDOUT, sprintf(
    "DATABASE SAFETY VERIFIED: APP_ENV=%s DB_CONNECTION=%s DB_HOST=%s DB_DATABASE=%s ALLOW_DESTRUCTIVE_TEST_DATABASE=%s DB_USER_SCOPE=sqlite-single-file-only\n",
    $testEnvironment, $testConnection, $testHost, $testDatabase, $destructiveAllowed,
));
